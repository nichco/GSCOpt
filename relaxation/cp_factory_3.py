...
def make_functions(i):
    ...
    def block_i_solve(v_init: list,
        ...
        l_list = [l1, l2, l3] # need to expand for changing N
        mp_list = [mp1, mp2, mp3] # need to expand for changing N
        x_list = [x1, x2, x3] # need to expand for changing N
        u_list = [u1, u2, u3] # need to expand for changing N
        ...
        j_list = [j1, j2, j3] # need to expand for changing N
...
def constraint(x_init: List[np.ndarray]) -> jnp.ndarray:
    ...
    c_l = consensus([l1, l2, l3]) # need to expand for changing N
    c_mp = consensus([mp1, mp2, mp3]) # need to expand for changing N
