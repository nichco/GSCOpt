...
def make_functions(i):
    ...
    def block_i_solve(v_init: list,
        ...
        l_list = [l1, l2, l3, l4] # need to expand for changing N
        mp_list = [mp1, mp2, mp3, mp4] # need to expand for changing N
        x_list = [x1, x2, x3, x4] # need to expand for changing N
        u_list = [u1, u2, u3, u4] # need to expand for changing N
...
def constraint(x_init: List[np.ndarray]) -> jnp.ndarray:
    ...
    c_l = consensus([l1, l2, l3, l4]) # need to expand for changing N
    c_mp = consensus([mp1, mp2, mp3, mp4]) # need to expand for changing N
...
# v_init = [l0, l0, l0, l0, mp0, mp0, mp0, mp0, x0, x0, x0, x0, u0, u0, u0, u0] # need to expand for changing N
v_init = []
...
l1, l2, l3, l4, mp1, mp2, mp3, mp4, x1, x2, x3, x4, u1, u2, u3, u4 = opt.solution # need to expand for changing N
print('l1: ', l1)
print('mp1: ', mp1)
print('l2: ', l2)
print('mp2: ', mp2)
...
plt.plot(objective[3:]) # skip the first infeasible iteration
