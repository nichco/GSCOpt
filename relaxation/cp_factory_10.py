...
def make_functions(i):
    ...
    def block_i_solve(v_init: list,
        ...
        l_list = [l1, l2, l3, l4, l5, l6, l7, l8, l9, l10] # need to expand for changing N
        mp_list = [mp1, mp2, mp3, mp4, mp5, mp6, mp7, mp8, mp9, mp10] # need to expand for changing N
        x_list = [x1, x2, x3, x4, x5, x6, x7, x8, x9, x10] # need to expand for changing N
        u_list = [u1, u2, u3, u4, u5, u6, u7, u8, u9, u10] # need to expand for changing N
        ...
        j10 = 0.5 * dt * np.sum(u10[:-1]**2 + u10[1:]**2)
        j_list = [j1, j2, j3, j4, j5, j6, j7, j8, j9, j10] # need to expand for changing N
...
def constraint(x_init: List[np.ndarray]) -> jnp.ndarray:
    ...
    c_l = consensus([l1, l2, l3, l4, l5, l6, l7, l8, l9, l10]) # need to expand for changing N
    c_mp = consensus([mp1, mp2, mp3, mp4, mp5, mp6, mp7, mp8, mp9, mp10]) # need to expand for changing N
